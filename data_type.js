...
/* 
    - nubmer 값들은 표기법만 다르고 값을 같을 수 있음
*/
...
/*
    - javascript의 문자열은 배열처럼 인덱스를 이용해서
    접근할 수 있음(유사 배열)
*/
...
/*
    undefined : 선언 이후에 값을 초기화하지 않는 변수는
    undefined를 가짐
    - 선언은 되었지만 값을 할당하지 않는 변수
    - 존재하지 않는 객체 속성
*/
...
/*
    ...
    - null 값은 typeof 타입확인 연산자로 확인하면 object
    타입이 반환됨(단순 자바스크립트 자체의 문제)
*/
obj = null;
